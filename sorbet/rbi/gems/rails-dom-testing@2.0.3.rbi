...
# source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:4
class HTMLSelector
  # @return [HTMLSelector] a new instance of HTMLSelector
  #
  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:7
  def initialize(values, previous_selection = T.unsafe(nil), &root_fallback); end

  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:33
  def context; end

  # Returns the value of attribute css_selector.
  #
  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:5
  ...
  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:25
  def select; end

  # @return [Boolean]
  #
  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:19
  ...
  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:87
  def extract_equality_tests; end

  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:59
  def extract_root(previous_selection, root_fallback); end

  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:76
  def extract_selectors; end

  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:35
...
# source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/html_selector.rb:31
HTMLSelector::NO_STRIP = T.let(T.unsafe(nil), Array)

# source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions.rb:4
module Rails
  class << self
...
# source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions.rb:5
module Rails::Dom; end

# source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions.rb:6
module Rails::Dom::Testing; end

# source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions.rb:7
...
# source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/dom_assertions.rb:5
...
#
# source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/count_describable.rb:7
...
# source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/count_describable.rb:8
...
# source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb:1
class SubstitutionContext
  # @return [SubstitutionContext] a new instance of SubstitutionContext
  #
  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb:2
  def initialize; end

  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb:16
  def match(matches, attribute, matcher); end

  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb:6
  def substitute!(selector, values, format_for_presentation = T.unsafe(nil)); end

  private

  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb:21
  def matcher_for(value, format_for_presentation); end

  # @return [Boolean]
  #
  # source://rails-dom-testing-2.0.3/lib/rails/dom/testing/assertions/selector_assertions/substitution_context.rb:30
