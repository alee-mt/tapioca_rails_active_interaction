...
module Rails
  class << self
    ...
    #
    # source://railties-6.1.6.1/lib/rails.rb:38
    def app_class; end
    ...
    # source://railties-6.1.6.1/lib/rails.rb:39
    def application; end
    ...
    #
    # source://railties-6.1.6.1/lib/rails.rb:37
    def application=(_arg0); end

    # source://railties-6.1.6.1/lib/rails.rb:112
    def autoloaders; end

    # source://railties-6.1.6.1/lib/rails.rb:50
    ...
    #
    # source://railties-6.1.6.1/lib/rails.rb:46
    ...
    #
    # source://railties-6.1.6.1/lib/rails.rb:72
    def env; end
    ...
    #
    # source://railties-6.1.6.1/lib/rails.rb:79
    def env=(environment); end

    # Returns the version of the currently loaded Rails as a <tt>Gem::Version</tt>
    #
    # source://railties-6.1.6.1/lib/rails/gem_version.rb:5
    def gem_version; end
    ...
    #
    # source://railties-6.1.6.1/lib/rails.rb:92
    def groups(*groups); end

    # source://railties-6.1.6.1/lib/rails.rb:43
    ...
    #
    # source://railties-6.1.6.1/lib/rails.rb:108
    def public_path; end
    ...
    #
    # source://railties-6.1.6.1/lib/rails.rb:63
    def root; end

    # Returns the version of the currently loaded Rails as a string.
    #
    # source://railties-6.1.6.1/lib/rails/version.rb:7
    def version; end
  end
end
...
class Rails::Application < ::Rails::Engine
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:128
  ...
  # source://railties-6.1.6.1/lib/rails/engine.rb:520
  def build_middleware_stack; end

  # source://railties-6.1.6.1/lib/rails/application.rb:402
  def config; end
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:406
  ...
  #     # => { baz: 1, qux: 2 }
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:241
  def config_for(name, env: T.unsafe(nil)); end

  # Sends any console called in the instance of a new application up
  # to the +console+ method defined in Rails::Railtie.
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:322
  def console(&blk); end
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:450
  def credentials; end
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:422
  def credentials=(_arg0); end

  # source://railties-6.1.6.1/lib/rails/application.rb:123
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:515
  def eager_load!; end
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:481
  def encrypted(path, key_path: T.unsafe(nil), env_key: T.unsafe(nil)); end

  # Stores some of the Rails initial environment parameters which
  # will be used by middlewares and engines to configure themselves.
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:268
  def env_config; end

  # Returns the value of attribute executor.
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:121
  def executor; end

  # Sends any generators called in the instance of a new application up
  # to the +generators+ method defined in Rails::Railtie.
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:328
  def generators(&blk); end

  # source://railties-6.1.6.1/lib/rails/application.rb:494
  def helpers_paths; end

  # Initialize the application passing the given group. By default, the
  # group is :default
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:389
  ...
  # @return [Boolean]
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:149
  def initialized?; end
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:310
  def initializer(name, opts = T.unsafe(nil), &block); end

  # source://railties-6.1.6.1/lib/rails/application.rb:396
  def initializers; end

  # Sends the +isolate_namespace+ method up to the class method.
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:339
  def isolate_namespace(mod); end

  # Returns the application's KeyGenerator
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:173
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:199
  ...
  # +railties_order+.
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:510
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:303
  def rake_tasks(&block); end

  # Reload application routes regardless if they changed or not.
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:168
  ...
  # source://railties-6.1.6.1/lib/rails/application.rb:365
  def require_environment!; end

  # source://railties-6.1.6.1/lib/rails/application.rb:370
  def routes_reloader; end

  # source://railties-6.1.6.1/lib/rails/application.rb:153
  def run_load_hooks!; end

  # Sends any runner called in the instance of a new application up
  # to the +runner+ method defined in Rails::Railtie.
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:316
  def runner(&blk); end

  # Returns the value of attribute sandbox.
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:119
  def sandbox; end
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:433
  def secret_key_base; end

  # source://railties-6.1.6.1/lib/rails/application.rb:408
  def secrets; end
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:334
  def server(&blk); end

  # source://railties-6.1.6.1/lib/rails/application.rb:490
  def to_app; end
  ...
  # API.
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:377
  def watchable_args; end

  protected

  # source://railties-6.1.6.1/lib/rails/application.rb:592
  def default_middleware_stack; end

  # Returns the ordered railties for this application considering railties_order.
  #
  # source://railties-6.1.6.1/lib/rails/application.rb:558
  def ordered_railties; end

  # source://railties-6.1.6.1/lib/rails/application.rb:580
  def railties_initializers(current); end

  # source://railties-6.1.6.1/lib/rails/application.rb:547
  def run_console_blocks(app); end

  # source://railties-6.1.6.1/lib/rails/application.rb:537
  def run_generators_blocks(app); end

  # source://railties-6.1.6.1/lib/rails/application.rb:542
  def run_runner_blocks(app); end

  # source://railties-6.1.6.1/lib/rails/application.rb:552
  def run_server_blocks(app); end

  # source://railties-6.1.6.1/lib/rails/application.rb:526
  def run_tasks_blocks(app); end

  # source://railties-6.1.6.1/lib/rails/application.rb:597
  def validate_secret_key_base(secret_key_base); end

  private

  # source://railties-6.1.6.1/lib/rails/application.rb:631
  def build_middleware; end

  # source://railties-6.1.6.1/lib/rails/application.rb:624
  def build_request(env); end

  # source://railties-6.1.6.1/lib/rails/application.rb:635
  def coerce_same_site_protection(protection); end

  # source://railties-6.1.6.1/lib/rails/application.rb:608
  ...
  class << self
    ...
    #
    # source://railties-6.1.6.1/lib/rails/application.rb:358
    def add_lib_to_load_path!(root); end

    # source://railties-6.1.6.1/lib/rails/application.rb:103
    def create(initial_variable_values = T.unsafe(nil), &block); end

    # source://railties-6.1.6.1/lib/rails/application.rb:107
    def find_root(from); end

    # @private
    #
    # source://railties-6.1.6.1/lib/rails/application.rb:92
    def inherited(base); end

    # source://railties-6.1.6.1/lib/rails/application.rb:99
    def instance; end
  end
end
...
class Rails::Application::Configuration < ::Rails::Engine::Configuration
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:29
  def initialize(*_arg0); end

  # Returns the value of attribute add_autoload_paths_to_load_path.
  #
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:14
  ...
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:342
  def annotations; end

  # Returns the value of attribute api_only.
  #
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:27
  def api_only; end

  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:223
  ...
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:362
  ...
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:302
  def colorize_logging; end

  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:306
  ...
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:346
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:277
  def database_configuration; end

  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:230
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:234
  def debug_exception_response_format=(_arg0); end

  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:374
  ...
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:215
  ...
  #
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:259
  def load_database_yaml; end

  # Loads default configurations. See {the result of the method for each version}[https://guides.rubyonrails.org/configuring.html#results-of-config-load-defaults].
  #
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:85
  ...
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:236
  def paths; end

  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:354
  ...
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:311
  def session_store(new_session_store = T.unsafe(nil), **options); end

  # @return [Boolean]
  #
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:338
  ...
  # @return [Boolean]
  #
  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:423
  def credentials_available_for_current_env?; end

  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:407
  def default_credentials_content_path; end

  # source://railties-6.1.6.1/lib/rails/application/configuration.rb:415
  def default_credentials_key_path; end
end

# source://railties-6.1.6.1/lib/rails/application.rb:125
...
class Rails::Engine < ::Rails::Railtie
  ...
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:432
  def initialize; end
  ...
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:537
  def call(env); end

  # Define the configuration object for the engine.
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:556
  def config; end

  # source://railties-6.1.6.1/lib/rails/engine.rb:484
  def eager_load!; end

  # Returns the endpoint for this engine. If none is registered,
  # defaults to an ActionDispatch::Routing::RouteSet.
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:532
  def endpoint; end

  # source://railties-6.1.6.1/lib/rails/engine.rb:430
  def engine_name(*_arg0, &_arg1); end

  # Defines additional Rack env configuration that is added on each call.
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:543
  def env_config; end

  # Returns a module with all the helpers defined for the engine.
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:503
  def helpers; end

  # Returns all registered helpers paths.
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:515
  def helpers_paths; end
  ...
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:446
  def load_console(app = T.unsafe(nil)); end

  # Load Rails generators and invoke the registered hooks.
  # Check <tt>Rails::Railtie.generators</tt> for more info.
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:470
  def load_generators(app = T.unsafe(nil)); end

  # Load Rails runner and invoke the registered hooks.
  # Check <tt>Rails::Railtie.runner</tt> for more info.
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:455
  ...
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:564
  def load_seed; end

  # Invoke the server registered hooks.
  # Check <tt>Rails::Railtie.server</tt> for more info.
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:479
  def load_server(app = T.unsafe(nil)); end

  # Load Rake, railties tasks and invoke the registered hooks.
  # Check <tt>Rails::Railtie.rake_tasks</tt> for more info.
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:462
  def load_tasks(app = T.unsafe(nil)); end

  # source://railties-6.1.6.1/lib/rails/engine.rb:429
  def middleware(*_arg0, &_arg1); end

  # source://railties-6.1.6.1/lib/rails/engine.rb:429
  def paths(*_arg0, &_arg1); end

  # source://railties-6.1.6.1/lib/rails/engine.rb:498
  def railties; end
  ...
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:549
  def routes(&block); end

  # @return [Boolean]
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:668
  def routes?; end

  protected

  # source://railties-6.1.6.1/lib/rails/engine.rb:673
  def run_tasks_blocks(*_arg0); end

  private

  # source://railties-6.1.6.1/lib/rails/engine.rb:705
  def _all_autoload_once_paths; end

  # source://railties-6.1.6.1/lib/rails/engine.rb:709
  def _all_autoload_paths; end

  # source://railties-6.1.6.1/lib/rails/engine.rb:713
  def _all_load_paths(add_autoload_paths_to_load_path); end

  # source://railties-6.1.6.1/lib/rails/engine.rb:729
  def build_middleware; end

  # source://railties-6.1.6.1/lib/rails/engine.rb:721
  def build_request(env); end

  # source://railties-6.1.6.1/lib/rails/engine.rb:701
  def default_middleware_stack; end

  # @return [Boolean]
  #
  # source://railties-6.1.6.1/lib/rails/engine.rb:685
  def has_migrations?; end

  # source://railties-6.1.6.1/lib/rails/engine.rb:679
  ...
  class << self
    ...
    #
    # source://railties-6.1.6.1/lib/rails/engine.rb:353
    def called_from; end
    ...
    # source://railties-6.1.6.1/lib/rails/engine.rb:358
    def eager_load!(*_arg0, &_arg1); end

    # source://railties-6.1.6.1/lib/rails/engine.rb:378
    def endpoint(endpoint = T.unsafe(nil)); end

    # source://railties-6.1.6.1/lib/rails/railtie.rb:176
    def engine_name(name = T.unsafe(nil)); end

    # Finds engine with given path.
    #
    # source://railties-6.1.6.1/lib/rails/engine.rb:416
    def find(path); end

    # source://railties-6.1.6.1/lib/rails/engine.rb:374
    def find_root(from); end

    # source://railties-6.1.6.1/lib/rails/engine.rb:689
    def find_root_with_flag(flag, root_path, default = T.unsafe(nil)); end

    # @private
    #
    # source://railties-6.1.6.1/lib/rails/engine.rb:360
    def inherited(base); end

    # source://railties-6.1.6.1/lib/rails/engine.rb:384
    def isolate_namespace(mod); end
